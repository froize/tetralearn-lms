...
<!--                            <li><a href="">Студенты</a></li>-->
                        ...
                        <div class="user-info">
                            <div class="photo">
                                ...
                                <?php if (!Yii::$app->user->isGuest && $user['avatar'] != '') :?><img src="/uploads/<?=$user['avatar']?>" class="dfx-img-rsp"/><?else:?>
                                    <img src="/img/photo.jpg" class="dfx-img-rsp"/><?endif;?>
                            </div>
                            <div class="info">
                            <span class="name"><?php if(Yii::$app->user->isGuest)  :?>
                                    <?='Гость'?>
                                    <?php else:?> <?=Html::a($user['name'], ['/admin/user/view', 'id' => $user['id']])?><?endif;?></span>
